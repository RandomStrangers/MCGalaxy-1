...
namespace MCGalaxy.Gui {
    ...
    public partial class PropertyWindow : Form {
        ...
        void ApplyRankProps() {
            ...
            Server.Config.OSPerbuildDefault = GuiPerms.GetPermission(rank_cmbOsMap, LevelPermission.Console);
        ...
        void rank_btnAdd_Click(object sender, EventArgs e) {
            ...
            int perm = 5;
            for (int i = (int)LevelPermission.Guest; i <= (int)LevelPermission.Console; i++) {
