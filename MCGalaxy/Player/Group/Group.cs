...
namespace MCGalaxy {
    ...
    public sealed partial class Group {
        ...
        public static Group WotRank { get { return Find(LevelPermission.Wot); } }
        ...
        public string Name;
        [ConfigPerm("Permission", null, LevelPermission.Wot)]
        public LevelPermission Permission = LevelPermission.Wot;
        ...
        public static void LoadAll() {
            ...
            if (File.Exists(Paths.RankPropsFile)) {
                ...
                Register(new Group(LevelPermission.Console, 2147483647, int.MaxValue, "Console", '0')); // 256^3
            ...
            if (ConsoleRank == null)
                Register(new Group(LevelPermission.Console, 2147483647, int.MaxValue, "Console", '0'));
            ...
            Player.Console.group = ConsoleRank;
