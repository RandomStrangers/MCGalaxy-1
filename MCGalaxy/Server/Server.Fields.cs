...
namespace MCGalaxy {
    public sealed partial class Server {
        ...
        public static string Version2 = "1.9.3.9";
        ...
        public static string StaticSoftwareNameVersioned
        {
            // By default, if SoftwareName gets externally changed, that is reflected in SoftwareNameVersioned too
        ...
        public static PlayerExtList frozen, muted, tempBans, tempRanks, jailed;
