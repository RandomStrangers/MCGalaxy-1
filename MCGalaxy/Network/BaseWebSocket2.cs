...
namespace MCGalaxy.Network
{
    ...
    public abstract class BaseWebSocket2 : INetSocket, INetProtocol
    {
    ...
    public abstract class ServerWebSocket2 : BaseWebSocket
    {
        bool version;
        string verKey;
    ...
    public abstract class ClientWebSocket2 : BaseWebSocket
    {
